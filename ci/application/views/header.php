...
<div class="row"> 
            <div class="col-6"> 
                ...
                <img src="image/jarditou_logo.jpg"  class="d-none d-md-block w-50 mt-2" alt="Image responsive" title="Image logo">
            </div>
            <div class="col-6">
               
                <h2 class="d-none d-md-block display-6 float-right mr-5 mt-3">Liste des produits</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                <img src="image/promotion.jpg"  class="w-100" alt="Image responsive" title="Image promotion">
            </div>
        </div>
